...
from basicsr.models.archs.real_restormer_arch import SUTNet
from basicsr.models.archs.msa_arch import MSA_Restormer
from basicsr.models.archs.exp_LeGD_arch import Exp_LeGD_Restormer
from basicsr.models.archs.up_down_exp_arch import Exp_up_down
from basicsr.models.archs.swint_arch import Swin_Restormer
...
parser.add_argument('--result_dir', default='./result/Real_Denoising/', type=str, help='Directory for results')
...
####### Load yaml #######
yaml_file = 'Options/RealDenoising_SUTNet.yml'
import yaml
