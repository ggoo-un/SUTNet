...
for dataset in datasets:
    ...
    gt_path = os.path.join('F:\Restormer-main\Denoising\Datasets','test', dataset)
    #gt_path = os.path.join('F:\Restormer-main\Denoising\Datasets/test')
    ...
    for sigma_test in sigmas:
        ...
        # file_path = os.path.join('F:\Restormer-main\Motion_Deblurring/result', dataset, str(sigma_test))
        #file_path = os.path.join('F:\Restormer-main\Motion_Deblurring/result', dataset)
