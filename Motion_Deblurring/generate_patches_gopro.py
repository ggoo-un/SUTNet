##### Data preparation file for training Network on the GoPro Dataset ########
...
def train_files(file_):
    ...
    if w > p_max and h > p_max:
        w1 = list(np.arange(0, w-patch_size, patch_size-overlap, dtype=np.int64))
        h1 = list(np.arange(0, h-patch_size, patch_size-overlap, dtype=np.int64))
...
tar = 'F:/Restormer-main/Motion_Deblurring/Dataset/train/GoPro'
