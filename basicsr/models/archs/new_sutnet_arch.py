...
class BasicLayer(nn.Module):
    ...
    def calculate_mask(self, x, x_size):
        ...
        mask_windows = mask_windows.view(-1,
                                         self.window_size * self.window_size)  # 重构结构为二维张量 [nW, window_size*window_size]
        attn_mask = mask_windows.unsqueeze(1) - mask_windows.unsqueeze(
            2)  # [nW, 1, Mh*Mw] - [nW, Mh*Mw, 1] # 增加第 2 维度减去增加第 3 维度的注意力 mask
        # [nW, Mh*Mw, Mh*Mw]
